...
因自身 Nas 拥有公网及阿里云服务器，目前采用映射端口和阿里云通过 Certbot 自动续签 `SSL 泛证书` & 反向代理使用；详细可参考 [Build Private Servers](https://17121203.xyz/notes/Project/build-private-servers.html)
